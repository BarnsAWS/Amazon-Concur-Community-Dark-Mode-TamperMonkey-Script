// ==UserScript==
// @name         Concur Community Dark Mode
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  High-contrast dark mode for community.concur.com (SAP Concur Community / Khoros / Lithium) — nuclear approach.
//               Color palette: AWS Cloudscape "Polaris Dark Mode" tokens v3.3.
// @author       BarnsAWS
// @match        https://community.concur.com/*
// @match        https://*.concur.com/*
// @grant        GM_addStyle
...
(function() {
    ...
    const SCRIPT_NAME = 'Concur Community Dark Mode';
    const STYLE_ID = 'concur-community-dark-mode-style';
